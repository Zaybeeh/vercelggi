      ...
      <Header />
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-6">
                <h3 className="about_growing_head">About Growing Globe Immigration</h3>
        ...
        <div className="requirements_section">
          <div className="container-fluid">
            <div className="row align_item_center">
              ...
              <div className="col-md-3">
                 <center><img src={Img.CICC} className="logo_img" alt=""></img></center>
              </div>
              <div className="col-md-3">
                 <img src={Img.Low_security} className="logo_img" alt=""></img>
              </div>
              <div className="col-md-3">
                 <img src={Img.town_of_Whitecourt_Logo} className="logo_img" alt=""></img>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="consultants">
          <div style={{ position: "relative" }}>
            ...
            <center><button className="book_an_appointment_btn meet_team">Meet Team</button></center>
          </div>
        </div>
